...
curl -O -L https://github.com/Graylog2/graylog2-server/releases/download/0.20.3/graylog2-server-0.20.3.tgz
tar xf graylog2-server-0.20.3.tgz
cp -R graylog2-server-0.20.3 /usr/share/graylog2-server
