...
curl -OL http://apache.osuosl.org/hbase/hbase-0.98.4/hbase-0.98.4-hadoop2-bin.tar.gz
tar xf hbase-0.98.4-hadoop2-bin.tar.gz
mv hbase-0.98.4-hadoop2 /opt/hbase
